...
export const TicketStatus = ({ status }) => {
    ...
    switch (status) {
        ...
        case TICKET_STATUS.PROCESSED:
            chip = <Chip size="small" label="Traité" color="success" />
            break;
        case TICKET_STATUS.CLOSED:
            chip = <Chip size="small" label="Fermé" color="success" />
            break;
        case TICKET_STATUS.REJECTED:
            chip = <Chip size="small" label="Rejeté" color="error" sx={{ color: 'white' }} />
            break;
