  ...
  return (
    <>
      ...
      >
        ...
        {projectToEdit && (
          <EditDialog
            ...
            handleClose={(app) => {
              if (app) {
                editMutation.mutate({ data: app, func: editProject });
              }
        ...
        {projectToDelete && (
          <DeleteDialog
            ...
            handleClose={(proj) => {
              if (proj) {
                deleteMutation.mutate({ data: proj.id, func: deleteProject });
              }
      ...
      <Grid
        ...
        rowSpacing={2}
      >
        {sortAndFilterData(projects, searchTerm, sortOption).map((project) => {
          const creator = users?.find((u) => u.id == project.createdBy);
          const creatorName = creator
            ? creator.firstname + " " + creator.lastname
            : "??";
          return (
            <Grid item component="paper" key={`proj-${project.id}`}>
              <Paper
                sx={{
